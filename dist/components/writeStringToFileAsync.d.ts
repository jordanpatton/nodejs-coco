 ...
 */
export declare const writeStringToFileAsync: ({ fromString, shouldMakeDirectory, toDirectory, toFileName, writeFileOptions, }: IWriteStringToFileAsyncParameters) => Promise<void>;
