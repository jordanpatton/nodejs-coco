 ...
 */
export declare const promisifyByException: <TArguments extends Array<unknown>, TResult>(fn: (...args: TArguments) => TResult | Promise<TResult>) => (...args: TArguments) => Promise<TResult>;
